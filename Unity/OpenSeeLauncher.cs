...
namespace OpenSee
{
    ...
    public class OpenSeeLauncher : MonoBehaviour
    {
        ...
        [Tooltip("The path to \"facetracker.exe\" relative to the Assets folder")]
        public string relativeExePath = "facetracker.exe";

        private string exePath
        {
            get { return Application.dataPath + "\\" + this.relativeExePath; }
        }

        [Tooltip("The path, where the .onnx model files can be found")]
        public string relativeModelPath = "models\\";

        private string modelPath
        {
            get { return Application.dataPath + "\\" + this.relativeModelPath; }
        }
